...
def reply():
    ...
    if bool(user) == False:
        msg = res.message("Hi, thanks for contacting *Kudzie Cakes*.\nYou can choose from one of the options below: "
        ...
        if option == 1:
            res.message(
                "You can contact us through phone or e-mail.\n\n*Phone*: +263 772 261 1120 \n*E-mail* : Kudziecakes@gmail.com")
        elif option == 2:
            ...
            res.message(
                "We have multiple stores across the city. Our main center is at *4/54, Harare*")
        else:
            res.message("Please enter a valid response")
